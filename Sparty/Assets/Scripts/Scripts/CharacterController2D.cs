...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		_vy = _rigidbody.linearVelocity.y;
		...
		_rigidbody.linearVelocity = new Vector2(_vx * moveSpeed, _vy);
	...
	public void DoJump() {
		// reset current vertical motion prior to jump
		_vy = 0f;
